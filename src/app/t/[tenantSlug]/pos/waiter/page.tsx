...
import { Utensils, FileText, LogOut, Maximize2, Minimize2, Settings } from "lucide-react";
...
function WaiterDashboardInner({ tenantSlug }: { tenantSlug: string }) {
  ...
  const accent = isDark ? '#e5b83b' : '#0f6b4a';
    ...
    >
      ...
      <main className="flex-1 max-w-7xl w-full mx-auto px-8 pb-12 pt-2 flex flex-col justify-between gap-12 overflow-hidden">
        ...
        <div className="space-y-2">
          ...
          <p
            style={{ color: isDark ? '#a1a1aa' : 'rgba(255,255,255,0.75)' }}
              ...
              >
                <div className="relative z-10 flex flex-col items-center">
                  ...
                  <h3
                    ...
                    style={{ color: isDark ? '#e5b83b' : accent }}
                  >
                    {mod.label}
                  </h3>
                </div>
...
export default function WaiterDashboard({ params }: WaiterDashboardProps) {
  ...
  return (
    <ThemeProvider role="waiter">
      <WaiterDashboardInner tenantSlug={tenantSlug} />
    </ThemeProvider>
  );
}